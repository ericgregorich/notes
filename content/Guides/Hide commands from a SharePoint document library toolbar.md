...
---
The toolbar that appears in a document library (or list) in [[Microsoft SharePoint|SharePoint]] Online can be customized (to an extent). We can hide, rename, change icons, and even rearrange the commands. 
