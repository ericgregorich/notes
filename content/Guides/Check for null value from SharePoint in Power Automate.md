...
---
If you use [[Microsoft Power Automate|Power Automate]] with [[Microsoft SharePoint|SharePoint]] Online list or library data and need to check if a field is empty or null, you can use the `@empty` function in an expression.
## Example
